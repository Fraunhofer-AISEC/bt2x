...
pub struct InactiveShardLogInfo {
    ...
    #[serde_as(as = "Hex")]
    pub root_hash: [u8; 32],    /// The current number of nodes in the merkle tree
    pub tree_size: u64,
...
impl InactiveShardLogInfo {
    pub fn new(root_hash: [u8; 32], tree_size: u64, signed_tree_head: String, tree_id: String) -> InactiveShardLogInfo {
